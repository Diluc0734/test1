<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.Master" AutoEventWireup="true" CodeBehind="trangchudemo.aspx.cs" Inherits="test1.trangchudemo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="rental" class="position-relative">
        <div class="container my-5 py-5">
            <h2 class=" text-center my-5 text-primary">Các dòng xe của chúng tôi </h2>
            ...
            <div class="swiper rental-swiper mb-5">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <a href="car-single.html"><img src="images/car1.png" class="card-img-top" alt="..."></a>
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <a href="car-single.html"><img src="images/car2.png" class="card-img-top" alt="..."></a>
                            <div class="card-body p-4">
                                <a href="car-single.html">
                    ...
                    <div class="swiper-slide">
                        <div class="card">
                            <a href="car-single.html"><img src="images/car3.png" class="card-img-top" alt="..."></a>
                            <div class="card-body p-4">
                                <a href="car-single.html">
        ...
        <div class="container  py-5 my-5">
            <div class="row py-5 ">
                ...
                <div class=" pb-5  col-lg-6">
                    <p class="pt-4">
                        Vitae aliquam vestibulum elit adipiscing massa diam in dignissim. Risus tellus
                        libero elementum aliquam etiam. Lectus adipiscing est auctor mi quisque nunc non vive adipiscing
                        massa diam in digniss imrra est.
                    </p>
                </div>
            </div>
                ...
                <div class="accordion-item mt-3">
                    ...
                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
                        <div class="accordion-body">
                            <p>
                                Diam orci gravida convallis at enim risus viverra. Hac mi tristique in aliquet tincidunt
    ...
    <section id="action" class="position-relative">
        ...
        <div class="container  py-5 my-5">
            <div class="row py-5 ">
                ...
                <div class=" col-lg-6">
                    <p>
                        Neque, vestibulum sed varius magna et at. Eu, adipiscing morbi augue justo. Nibh laoreet volutpat
